...
// (video_feedback_update_same_client, supabase/migrations/011_feedback_resolve_policies.sql)
// ja restringe a linhas do mesmo client_id do content_item pai -- aqui so limitamos o
// shape do update para nao permitir reescrever timestamp_seconds/comment/created_by.
