// Gerado via mcp__supabase__generate_typescript_types a partir do projeto real
// (plataforma-agencia, lyocisdvelfabvlmdyjh). Para regenerar após novas migrations:
//   npx supabase gen types typescript --project-id lyocisdvelfabvlmdyjh > lib/supabase/types.ts
